...
from fastapi import Depends, FastAPI, HTTPException, status, Body, Request, Query
...
def get_tournament_from_list(tournois_choisi: Union[str, None] = 'FRENCH OPEN'):
...
def new_game_list(date: str = Query('2018-03-03'), player1: Union[str, None] = 'Jarry N.', player2: Union[str, None] = 'Zeballos H.'):
...
def new_game_pred(date: Union[str, None] = Query('YYYY-MM-DD'), player1: Union[str, None] = 'Jarry N.', player2: Union[str, None] = 'Zeballos H.'):
    """Return the game between 2 players on a specific date"""
    #player1=player1.upper()
    #player2=player2.upper()
    df_preprocessed= data_preprocessed()
